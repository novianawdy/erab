...
@section('content')
    @include('users.partials.header', ['title' => __('Add Job')])
            ...
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-jobs-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Jobs Management') }}</h3>
                            </div>
                        ...
                        <form method="post" action="{{ route('jobs.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-name">{{ __('Job Name') }}</label>
                                ...
                                <div class="form-group{{ $errors->has('category') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-category">{{ __('Category Name') }}</label>
                                    <input  type="text" name="category" id="input-category" class="form-control form-control-alternative{{ $errors->has('item') ? ' is-invalid' : '' }}" rows="3" placeholder="{{ __('Category') }}" value="{{ old('category') }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('type') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="type" id="input-type" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Type') }}" value="{{ old('type') }}" required autofocus>
                                  ...
                                  @else
                                    <div class="row item-detail-root">
                                      <div class="col-md-2">
                                        <div class="form-group{{ $errors->has('coefisien') ? ' has-danger' : '' }}">
                                          <label class="form-control-label" for="input-coefisien">{{ __('Coefisien') }}</label>
                                          <input type="text" name="coefisien[]" class="input-coefisien form-control form-control-alternative{{ $errors->has('coefisien') ? ' is-invalid' : '' }}" placeholder="{{ __('Coefisien') }}" value="{{ old('coefisien') }}" required autofocus>
                                      ...
                                      <div class="col-md-3">
                                        <div class="form-group{{ $errors->has('item_id') ? ' has-danger' : '' }}">
                                          <label class="form-control-label" for="input-item_id">{{ __('Item') }}</label>
                                          <select name="item_id[]" class="select-item form-control form-control-alternative{{ $errors->has('item_id') ? ' is-invalid' : '' }}" placeholder="{{ __('Item') }}" value="{{ old('item_id') }}" required autofocus id="input-item_id">
                                            <option selected disabled value="">Select item</option>
                                            @foreach ($items as $item)
                                      ...
                                      <div class="col-md-1">
                                        <div class="form-group{{ $errors->has('unit') ? ' has-danger' : '' }}">
                                          <label class="form-control-label" for="input-unit">{{ __('Unit') }}</label>
                                          <input readonly type="text" name="unit[]" class="form-control form-control-alternative{{ $errors->has('unit') ? ' is-invalid' : '' }}" placeholder="{{ __('Unit') }}" value="{{ old('unit') }}" required autofocus>
                                          @if ($errors->has('unit'))
                                            <span class="invalid-feedback" role="alert">
                                              <strong>{{ $errors->first('unit') }}</strong>
                                            </span>
                                      ...
                                      <div class="col-md-3">
                                        <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                                          <label class="form-control-label" for="input-price">{{ __('Price') }}</label>
                                          <input type="number" name="price[]" class="input-price form-control form-control-alternative{{ $errors->has('price') ? ' is-invalid' : '' }}" placeholder="{{ __('Price') }}" value="{{ old('price') }}" required autofocus>
