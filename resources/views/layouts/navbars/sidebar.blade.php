            ...
            <ul class="navbar-nav">
                ...
                @if (Auth::user()->email=='e.rancanganbiaya@gmail.com')
                  <li class="nav-item">
                      ...
                      <i class="ni ni-badge text-success"></i> {{ __('User Management') }}
                      </a>
                  </li>
                @endif
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('clients.index') }}">
                        <i class="ni ni-single-02 text-info"></i> {{ __('Clients') }}
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="{{ route('jobs.index') }}">
                        <i class="ni ni-settings text-orange"></i> {{ __('Jobs') }}
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="{{ route('projects.index') }}">
                        <i class="ni ni-building text-blue"></i> {{ __('Projects') }}
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="{{ route('items.index') }}">
                        <i class="ni ni-ruler-pencil text-info"></i> {{ __('Items') }}
                    </a>
                </li>
                {{-- <li class="nav-item">
